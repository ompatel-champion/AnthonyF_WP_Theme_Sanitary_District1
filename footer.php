...
<footer class="main-footer">
		<section class="email-wrapper">
			<div class="container align">
				<div class="email-wrapper-content">
					...
					<p>For Up To Date Alerts about your Sanitary District Services</p>
				</div>
				<div class="email-wrapper-form">
					<input type="text" class="enter-email" name="EMAIL" id="subscribe-email" placeholder="Enter your email address" spellcheck="false">
            		<button type="submit" id="signup-button" class="signup-button"><i class="fas fa-paper-plane"></i></button>
				</div>
			</div>
			...
			<div class="row">
				...
				<ul>
					...
					<?php
						wp_nav_menu(
							array(
								'theme_location' 	 => 'customer-support',
								'menu_id' 				=> 'customer-support',
								'items_wrap'      	   => '<ul class="footer-nav">%3$s</ul>'
							)
						);
					?>
		...
		<section class="copyright">
			<div class="container">
				&copy; 2021 Sanitation Distirict 1 | <a href="#">Sitemap</a> | <a href="#">Privacy Policy</a> | <a href="#">Terms of Use</a> | Designed by <a href="#">FInal Elements</a>
			</div>
		</section>
	</footer>
